...
function handleRestoreHistory(
  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-white sm:px-6 sm:py-12 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base leading-7 text-slate-400 sm:text-lg">
            ...
            description, discover missing keywords,
            measure achievement quality, identify
            formatting problems, and rewrite weak
            bullets using AI.
          </p>
...
<div className="flex flex-col justify-center gap-3 sm:flex-row">
  ...
  >
    Print Results
        ...
        <footer className="mt-20 border-t border-slate-900 py-8 text-center text-sm text-slate-500">
          © 2026 Resume Impact AI. ATS results and
          AI rewrites are estimates and should be
          reviewed before use.
        </footer>
      </div>
    </main>
