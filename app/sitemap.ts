...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${baseUrl}/guides/how-to-tailor-resume-to-job-description`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guides/ats-friendly-resume-format`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guides/resume-keywords-for-ats`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/guides/skills-to-put-on-a-resume`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/guides/how-to-write-work-experience-on-resume`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guides/how-to-list-education-on-resume`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/guides/delivery-driver-resume-bullets`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guides/security-guard-resume-bullets`,
      lastModified: new Date("2026-08-08"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
